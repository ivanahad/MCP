...
Pour cette preuve, nous allons poser que \textbf{y} est égal à la longueur du cadran, et \textbf{i} représente le nombre d'éléments correctement placés dans le cadran.\\
